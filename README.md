...
Pour le lien Maps, utilise exactement ce format : https://www.google.com/maps/search/?api=1&query=[ADRESSE_ENCODEE]
...
# --- LE MOULE HTML AVEC LES SCRIPTS CORRECTS ---
...
# --- INTERFACE ---
st.title("🗞️ Tournée RL - Version Finale")
up = st.file_uploader("Photo de la feuille :", type=["jpg